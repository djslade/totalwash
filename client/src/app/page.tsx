...
export default function Home() {
  return (
    <main className="flex flex-col justify-center items-start h-screen p-6 bg-landing text-white gap-12">
      <Link className="absolute top-6 left-6 text-2xl"  href="/store">
        <span>Total</span>
      ...
      <section className="max-w-2xl flex flex-col justify-center items-start gap-12 brightness-100">
        ...
        <Link href="/store" className="uppercase bg-white text-black px-9 py-2 rounded-md border-black font-sans font-bold brightness-100 hover:brightness-90 focus:brightness-90">Continue to Store</Link>
      </section>
    </main>
  )
}
