  ...
  return (
    <main className="bg-landing text-white h-screen w-screen flex items-center max-w-full max-h-full">
      <section className="px-10 max-w-xl">
        ...
        <div className="">
          <Link href="/catalog" className="text-center uppercase bg-gray-50 text-gray-700 text-sm px-5 whitespace-nowrap py-2 hover:rounded-md focus:rounded-md border-black font-sans font-bold hover:bg-gray-200 focus:bg-gray-200 transition-all">Continue to Store</Link>
        </div>
      </section>
    </main>
  )
