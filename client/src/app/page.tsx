  ...
  return (
    <main className="bg-landing text-white h-screen w-screen flex items-center max-w-full max-h-full">
      <section className="px-10 max-w-xl">
        ...
        <div className="">
          <Link href="/catalog" className="text-center uppercase bg-white text-gray-900 px-5 whitespace-nowrap py-2 rounded-md border-black font-sans font-semibold brightness-100 hover:brightness-90 focus:brightness-90">Continue to Store</Link>
        </div>
      </section>
    </main>
  )
