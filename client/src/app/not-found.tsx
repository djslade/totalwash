    ...
    return (
        ...
        <main className="h-full max-w-screen-lg flex justify-center items-center mx-auto gap-6 my-6">
            <section className="max-w-sm flex flex-col items-center gap-3 p-3">
                <img src="/notfound.webp" alt="Not Found" className='max-w-sm w-full mb-5'/>
                ...
                <Link
                href="/catalog"
                className="border py-1 bg-gray-50 text-gray-700 rounded-md border-gray-700 font-sans font-medium hover:bg-gray-200 focus:bg-gray-200 transition-all w-max px-3">Return to Store</Link>
            </section>
