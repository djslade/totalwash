...
export const RenderedCartItem = ({
    ...
    return (
        <tr key={cartItem.product._id} className="border-b w-full text-gray-700">
            ...
            <td className="px-3 py-3 align-top text-lg font-medium">{formatPrice(cartItem.product.currentPrice)}</td>
            ...
            <td className="px-3 py-3 align-top text-lg font-medium">{formatPrice(cartItem.subtotal)}</td>
        </tr>
    )
}
