    ...
    <>
      {!card === true ? (
        <button
          ...
          className="w-full border py-3 uppercase bg-blue-400 rounded-md text-gray-100 font-sans font-bold hover:bg-blue-500 focus:bg-blue-500 transition-all"
        >
        ...
        <button
          onClick={handleAddToCart}
          className="flex-1 border py-2.5 uppercase bg-blue-400 rounded-md text-gray-100 font-sans font-bold hover:bg-blue-500 focus:bg-blue-500 transition-all"
        >
          {loading ? "Adding..." : "Add to Cart"}
        </button>
      )}
      <AnimatePresence>
        {showModal && (
          <AddToCartModal product={product} closeModal={handleCloseModal} />
        )}
      </AnimatePresence>
    </>
  );
