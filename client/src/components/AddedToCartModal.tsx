  ...
  return (
    <ModalPortal>
      <FocusLock>
        ...
        <div
          onClick={closeModal}
          className="inset-0 fixed z-[100] bg-transparent flex justify-center items-center"
        >
          <motion.div
          ...
          >
            <button
              onClick={closeModal}
              className="-top-3 -right-3 text-black bg-white rounded-full border border-black absolute text-3xl"
            >
              <AiFillCloseCircle />
            </button>
              ...
              <div className="flex flex-col p-6 gap-6">
                <div className="flex gap-2 items-center w-full">
                  ...
                  <h1 className="text-xl">
                    {formatCartCount(snap.cartContents.length)}
                  </h1>
                </div>
                ...
                <div className="flex gap-3 flex-col w-full">
                  <button
                    onClick={closeModal}
                    className="line-clamp-1 flex-1 border py-2.5 bg-white text-gray-900 rounded-md border-gray-500 font-sans font-bold brightness-100 hover:brightness-90 focus:brightness-90"
                  >
                    Continue Shopping
                  </button>
                  <button
                    ...
                    className={
                      "flex-1 border py-2.5 uppercase bg-blue-500 rounded-md text-white font-sans font-bold brightness-100 hover:brightness-90 focus:brightness-90"
                    }
                  >
                    Go to Cart
                  </button>
