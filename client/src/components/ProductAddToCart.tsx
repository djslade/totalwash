    ...
    <div className="flex gap-3 my-12 text-sm xs:items-center flex-col xs:flex-row p-3">
      <div className="flex items-center h-10">
        <button
          ...
          className="text-xl border border-gray-700 h-full aspect-square flex justify-center items-center bg-gray-200 hover:bg-gray-700 hover:text-gray-100 transition-all focus:bg-gray-700 focus:text-gray-100"
        >
          <BiMinus />
        </button>
        <input
