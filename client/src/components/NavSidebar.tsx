...
export const NavSidebar = () => {
    ...
    return (
        <>
        <div className={`z-10 top-0 left-0 right-0 bottom-0 bg-black opacity-10 ${snap.showNavSidebar ? 'fixed' : 'hidden'}`}/>
        <div ref={modalRef} className={`p-10 pr-20 top-0 left-0 max-w-sm bg-[#F5F5F5] fixed h-full z-10 ease-in-out duration-300 border-r-2 transition-transform ${snap.showNavSidebar ? 'translate-x-0' : '-translate-x-full'}`}>
